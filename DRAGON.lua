...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝕎𝕆𝕃f ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝕎𝕆𝕃f ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝕎𝕆𝕃f ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Bandaa2/WOLF/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,bot_id,1373616147,1223908266,1409176813}   
...
if tonumber(user_id) == tonumber(1638974687) then  
var = true
if tonumber(user_id) == tonumber(1223908266) then  
var = true
if tonumber(user_id) == tonumber(1409176813) then  
var = true  
...
if tonumber(user_id) == tonumber(1409176813) then  
var = 'لوسيفر مبرمج السورس'
if tonumber(user_id) == tonumber(1638974687) then
var = 'الصعيدي مطور السورس'
if tonumber(user_id) == tonumber(1223908266) then
var = 'صاحب السورس حربوكا'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الاساسي²"  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'لوسيفر'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "s_o_u_r_c_e_w_ol_f")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝕊𝕆ŭℝℂ𝔼 𝕎𝕆𝕀𝔽")  
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/WOLF/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✵ تم تحديث السورس \n ✵ لديك اخر اصدار لسورس لوسيفر\n ✵ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✵ اصدار سورس لوسيفر \n ✵ الاصدار »{ v 1.5}')
end
if text == 'لوسيفر مبرمج السورس✪' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV lucifer✭](t.me/LLucifeerr)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝕋𝕎𝔸𝕊𝕆𝕃', url="t.me/gejdkdk_bot"}}, 
} 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/s_o_u_r_c_e_w_ol_f)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/s_o_u_r_c_e_w_ol_f"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/gejdkdk_bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝔹𝕆𝕋 𝕃𝕌ℂ𝕀f𝔼ℝ', url="t.me/LUCIFER2900_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ✵ العضو » ['..result.title_..'](t.me/'..(username or 's_o_u_r_c_e_w_ol_f')..')'
status  = '\n ✵ تم ترقيته مطور'
...
usertext = '\n ✵ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_u_r_c_e_w_ol_f')..')'
status  = '\n ✵ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✵ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_o_u_r_c_e_w_ol_f')..') \n ✵ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✵ العضو : {["..data.first_name_.."](T.ME/s_o_u_r_c_e_w_ol_f)}\n ✵ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✵ عذرا » {["..data.first_name_.."](T.ME/s_o_u_r_c_e_w_ol_f)}\n ✵ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
✭𝕎𝔼𝕀 ℂ𝕆𝕄 𝕀ℕ 𝕊𝕆ŭℝℂ𝔼 𝕎𝕆𝕀 𝔽✭
☆اهلا بيك في سورس ولف الاعظم☆
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DEV 𝐋𝐔𝐂𝐈𝐅𝐄𝐑✭',url="t.me/LLucifeerr"}},
{{text = 'DEV HARBOKA✭', url="t.me/dad7rboka"}},
{{text = '𝕋𝕎𝔸𝕊𝕆𝕃✭', url="t.me/gejdkdk_bot"}},
{{text = 'SOURCE WOLF✭', url="t.me/s_o_u_r_c_e_w_ol_f"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' or text == 'مين عدلك' then
local Text = [[
𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐖𝐎𝐋𝐅✪
✪اهلا بيك في سورس ولف يقلبي♥✪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DEV lucifer✪',url="t.me/LLucifeerr"}},
{{text = 'DEV harboka✪',url="t.me/dad7rboka"}}, 
{{text = 'twasol✪',url="t.me/gejdkdk_bot}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'كساحه' or text == 'المبرمج' or text == 'مبرمج السورس' or text == 'لوسيفر ' then
local Text = [[
DEV lucifer
]]
keyboard = {} 
...
if text == 'لوسيفر' or text == 'صاحب السورس' or text == 'مطور السورس' then
local Text = [[
🕸️صاحب السورس لوسيفر وحربوكا يقلبي يقلبي🕸️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'LUSEFAR',url="t.me/LLucifeerr"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس لوسيفر ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس لوسيفر ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝕊𝕆ŭℝℂ𝔼 𝕎𝕆𝕀 𝔽', url="t.me/s_o_u_r_c_e_w_ol_f"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[𝕃𝕌ℂ𝕀f𝔼ℝ](t.me/LLucifeerr)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝔻𝔼𝕍 𝐋𝐔𝐂𝐈𝐅𝐄𝐑', url="t.me/LLucifeerr"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'العاب لوسيفر' then
local Text = [[
𝕊𝕆ŭℝℂ𝔼 𝕎𝕆𝕀𝔽
]]
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✵ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_o_u_r_c_e_w_ol_f')..') \n ✵ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✵ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 's_o_u_r_c_e_w_ol_f')..') \n ✵ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber() then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك حظر المطور الصعيدي \n")
return false
end
if result.sender_user_id_ == tonumber(1223908266) then
send(msg.chat_id_, msg.id_, " ✵لا يمكنك حظر مالك السورس حربوكا\n")
return false
end
if result.sender_user_id_ == tonumber(1409176813) then
send(msg.chat_id_, msg.id_, " ✵لا يمكنك حظر مبرمج السورس لوسيفر\n")
return false 
end
...
function(arg,data) 
usertext = '\n 🕸️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_u_r_c_e_w_ol_f')..')'
...
if result.sender_user_id_ == tonumber() then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك حظر عام المطور الصعيدي \n")
return false
end
if result.sender_user_id_ == tonumber(1223908266) then
send(msg.chat_id_, msg.id_, " ✵لا يمكنك حظر عام صاحب السورس حربوكا\n")
return false
end
if result.sender_user_id_ == tonumber(1409176813) then
send(msg.chat_id_, msg.id_, " ✵لا يمكنك حظر عام صاحب السورس لوسيفر\n")
return false 
end
usertext = '\n 🕸️ العضو » ['..result.title_..'](t.me/'..(username or 's_o_u_r_c_e_w_ol_f')..')'
status  = '\n 🕸️ تم حظره عام من الكروبات'
texts = usertext..status
...
if result.sender_user_id_ == tonumber(1373616147) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك كتم المبرمج فامبير\n")
return false
end
if result.sender_user_id_ == tonumber(1223908266) then
send(msg.chat_id_, msg.id_, " ✵لا يمكنك كتم المطور حربوكا\n")
return false
end
if result.sender_user_id_ == tonumber(1409176813) then
send(msg.chat_id_, msg.id_, " ✵لا يمكنك كتم صاحب السورس لوسيفر\n")
return false  
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if result.sender_user_id_ == tonumber(1638974687) then
send(msg.chat_id_, msg.id_, " ✪لا يمكنك كتم المطور الصعيدي \n")
return false
end
if result.sender_user_id_ == tonumber(1223908266) then
send(msg.chat_id_, msg.id_, " ✵لا يمكنك كتم صاحب السورس حربوكا\n")
return false
end
if result.sender_user_id_ == tonumber(1409176813) then
send(msg.chat_id_, msg.id_, " ✵لا يمكنك كتم المبرمج السورس لوسيفر\n")
return false
end
usertext = '\n 🕸️ العضو » ['..result.title_..'](t.me/'..(username or 's_o_u_r_c_e_w_ol_f')..')'
status  = '\n 🕸️ تم كتمه عام من الكروبات'
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/WOLF/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✵ اهلا بك في متجر ملفات لوسيفر\n ✵ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝕎𝕆𝕃f ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ 𝕎𝕆𝕃f ┉  ┉ ┉ ┉ ┉≫ٴ\n ✵ علامة تعني { ✔️ } ملف مفعل\n ✵ علامة تعني { ✖ } ملف معطل\n ✵ قناة سورس لوسيفر ↓\n".." ✵ [اضغط هنا لدخول](t.me/s_o_u_r_c_e_w_ol_f) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/WOLF/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ✵ عذرا الملف لايدعم سورس لوسيفر \n") 
end
return false
end
...
if text == ("مسح قائمه لوسيفر") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✵ تم مسح قائمه لوسيفر')
return false
end

if text == 'قائمه لوسيفر' and Sudo(msg) then
...
if text == ("رفع لوسيفر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع لوسيفر @(.*)$") and Sudo(msg) then
local username = text:match("^رفع لوسيفر @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع لوسيفر (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع لوسيفر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل لوسيفر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل لوسيفر @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل لوسيفر @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل لوسيفر (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل لوسيفر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✵ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_u_r_c_e_w_ol_f')..')'
status  = '\n ✵ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✵ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✵ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_u_r_c_e_w_ol_f')..')'
...
' }\n'..' ✵  الايدي بالصوره » { '..idph..
' }\n'..' ✵  الرفع » { '..setadd..
' }\n'..' ✵  الحظر » { '..banm..' }\n\nٴ≪┉ ┉ ┉ ┉ ┉ 𝕎𝕆𝕃f ┉  ┉ ┉ ┉ ┉≫ٴ\n ✵ قناة سورس لوسيفر ↓\n [ 𝕊𝕆ŭℝℂ𝔼 𝕎𝕆𝕀𝔽](t.me/s_o_u_r_c_e_w_ol_f) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✵ العضو » ['..result.title_..'](t.me/'..(text1[3] or 's_o_u_r_c_e_w_ol_f')..')'..'\n ✵ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'لوسيفر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'لوسيفر')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
database:set(bot_id.."s_o_u_r_c_e_w_ol_f:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."s_o_u_r_c_e_w_ol_f:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."s_o_u_r_c_e_w_ol_f:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."s_o_u_r_c_e_w_ol_f:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✵تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."s_o_u_r_c_e_w_ol_f:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."s_o_u_r_c_e_w_ol_f:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس لوسيفر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'لوسيفر').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_u_r_c_e_w_ol_f')..')'
local iduser = result.sender_user_id_
...
{
{text = 'SOURCE WOLF', url="t.me/s_o_u_r_c_e_w_ol_f"},
{text = 'مبرمج السورس', url="t.me/LLucifeerr"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝕎𝕆𝕃f ┉  ┉ ┉ ┉ ┉≫ٴٴ\n✵ [ 𝕊𝕆ŭℝℂ𝔼 𝕎𝕆𝕀𝔽 ](t.me/s_o_u_r_c_e_w_ol_f)')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'لوسيفر')
